...
public class SucceedsWhenLastLimitEvaluationDateIsMoreThanThirtyDays(AppFixture fixture) 
    : GivenAccountWithLastLimitEvaluationDateOlderThanThirtyDaysExist(fixture)
{
